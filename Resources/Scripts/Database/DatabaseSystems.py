...
class DatabaseSystems(Database):
    def __init__(self):
        ...
        self.addRecord(Module="Foundation.Systems", Name="SystemAndroidAppLovin", Global=1, Platform="ANDROID")
        self.addRecord(Module="Foundation.Systems", Name="SystemAppleAppLovin", Global=1, Platform="IOS")
