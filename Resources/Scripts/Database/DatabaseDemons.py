...
class DatabaseDemons(Database):
    def __init__(self):
        ...
        self.addRecord(DemonName="Backpack", GroupName="01_Backpack", ObjectName="Demon_Backpack")
        self.addRecord(DemonName="Backpack", GroupName="02_Backpack", ObjectName="Demon_Backpack")
