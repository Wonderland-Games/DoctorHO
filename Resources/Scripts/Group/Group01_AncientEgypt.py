...
class Group01_AncientEgypt(Group):
    ...
    def _onLoader(self):
        ...
        self.createObject( "Item", Name = "Item_Torch", Position = (549,778), SpriteResourceNameFull = "01_AncientEgypt/Layer2D_Main/Item_Torch/_Item_Torch[Full]" , HotspotImageResourceName = "01_AncientEgypt/Layer2D_Main/Item_Torch/_Item_Torch[Pick]", PickOffset = (-34, -36) )
        ...
        self.createObject( "Sprite", Name = "Sprite_Foreground", Position = (493,918), SpriteResourceName = "01_AncientEgypt/Layer2D_Main/Sprite_Foreground/Sprite_Foreground" )
        pass
    pass
