...
class Group02_Backpack(Group):
    ...
    def _onLoader(self):
        ...
        self.addPrototype( "Movie2", Name = "Movie2_ChapterSlots" , ResourceMovie = "Movie2_02_Backpack", CompositionName = "ChapterSlots"  )
        self.addPrototype( "Movie2Button", Name = "Movie2Button_FinalStageButton", ResourceMovie = "Movie2_02_Backpack", CompositionNameIdle = "FinalStageButton_Idle", CompositionNameAppear = "FinalStageButton_Appear", CompositionNameEnter = "FinalStageButton_Enter", CompositionNameOver = "FinalStageButton_Over", CompositionNameLeave = "FinalStageButton_Leave", CompositionNamePush = "FinalStageButton_Push", CompositionNamePressed = "FinalStageButton_Pressed", CompositionNameRelease = "FinalStageButton_Release", CompositionNameClick = "FinalStageButton_Click", CompositionNameBlock = "FinalStageButton_Block", CompositionNameBlockEnter = "FinalStageButton_BlockEnter", CompositionNameBlockEnd = "FinalStageButton_BlockEnd", CompositionNameSelected = "FinalStageButton_Selected", CompositionNameSelectedEnter = "FinalStageButton_SelectedEnter", CompositionNameSelectedEnd = "FinalStageButton_SelectedEnd" )
        pass
    pass
