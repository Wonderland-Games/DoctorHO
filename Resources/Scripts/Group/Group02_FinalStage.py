...
class Group02_FinalStage(Group):
    ...
    def _onLoader(self):
        ...
        self.createObject( "Movie2", Name = "Movie2_BG" , ResourceMovie = "Movie2_02_FinalStage", CompositionName = "BG"  )
        ...
        self.createObject( "Movie2", Name = "Movie2_Final" , ResourceMovie = "Movie2_02_FinalStage", CompositionName = "Final"  )
        pass
    pass
